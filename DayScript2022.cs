...
public class DayScript2022 : MonoBehaviour
{
    ...
    protected IEnumerator coDay()
    {
        ...
        if (!IsTestInput)
        {
            yield return StartCoroutine(Tools2022.Instance.GetInput(_day));
            _input = Tools2022.Instance.Input;
        }
        else
        {
            yield return StartCoroutine(Tools2022.Instance.GetTestInput("https://ollivier.iiens.net/AoC/2022/" + _day + ".txt"));
            _input = Tools2022.Instance.Input;
        }
